            ...
            GET으로 viewtest로 보낸다. -->
                ...
                if($board['lock_post']=="1"){ ?>
                    ...
                    <?php                                         
                      if(isset($_SESSION['id'])){ ?>
                        ...
                        <a href='viewcheckviewbottom.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>'><?php echo $title, $lockimg;?>
               ...
               <?php }else{  ?>
                    ...
                    <?php                                           
                        ...
                        <!-- viewtest.php에서 viewreplytest.php로 고쳤다. GET으로 게시판 idx, idxpost, category를 보낸다. -->
                         <a href="viewpagereplybottom.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>"><?php echo $title; ?>
