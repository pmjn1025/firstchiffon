...
<a href="home.php" class="title1">Chiffons</a>
    ...
    <div class="board_wrap">
       ...
       <?php
        ...
        $hit = mysqli_fetch_array(mq("select * from blueshirtsposttest where idx ='$idx'"));
        // 조회수에 1을 더해준다.
        $hit = $hit['hit'] + 1;
        // 조회수에 1을 더해준것을 db에 최신화 시켜준다.
        //boardtest table에서 boartposttest table로 바꿨다.
		$fet = mq("update blueshirtsposttest set hit = '$hit' where idx = '$idx'");
       ...
       <!-- 글쓰는 영역 -->
           <div class="board_view">
            ...
            <div class="bt_wrap">
                <a href="blueshirts.php" class="on">목록</a>
                <!-- idx값을 GET으로 넘겨준다 -->
                <a href="blueshirtsedittest.php?idx=<?php echo $board['idx']; ?>">수정</a>
                <!--delete.php에서 checkdeleteview.php로 바꿨다.  -->
                <a href="blueshirtscheckdeleteview.php?idx=<?php echo $board['idx']; ?>">삭제</a>
...
<div class="reply_view">
	<div class="reply_title">댓글목록</div>
		<?php
			$sql3 = mq("select * from blueshirtsreplytest where con_num='$idx' order by idx desc");
		...
		<div class="dap_lo">
			...
			<!-- 댓글 수정 폼 dialog -->
			<div class="dat_edit">
				<form method="post" action="blueshirtsreplyedittest_process.php">
			...
			<div class='dat_delete'>
				...
				<form action="blueshirtsreplydeletetest_process.php" method="post">
					<input type="hidden" name="rno" value="<?php echo $reply['idx']; ?>" />
                    <input type="hidden" name="b_no" value="<?php echo $idx; ?>">
	...
	<div class="dap_ins">
		<form action="blueshirtsreplytest_process.php?idx=<?php echo $idx; ?>" method="post">
