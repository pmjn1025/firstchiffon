...
// 밑에 idx는 shopdatanewrelease테이블의 idx이다!!!!!
 ...
 $sql = mq("select * from shopdatashoes where idx='$idx'"); /* 받아온 idx값을 선택 */
...
?>
            ...
            <div class="modeldescription1">
             ...
             if(isset($_SESSION['id'])){ ?>
                ...
                if($board['title'] == '컨버스 하이'){?>
                    ...
                    <?php } else if($board['title'] == '나이키 에어포스'){?>
                    <p> 사이즈 :
                        <SELECT NAME=size SIZE=1>
                            <OPTION VALUE=1 SELECTED>사이즈를 선택해 주세요.</OPTION>
                            <OPTION VALUE="230">230</OPTION>
                ...
                if($board['color1'] == '블랙'){?>
                    ...
                    <p> 색상 :
                        <SELECT NAME=color SIZE=1>
                            <OPTION VALUE=1 SELECTED>색상을 선택해 주세요.</OPTION>
                            <OPTION VALUE="deepblue">파스텔</OPTION>
    ...
    <div class="detailimg">
            ...
            GET으로 viewtest로 보낸다. -->
                ...
                if($board['lock_post']=="1"){ ?>
                      ...
                      if(isset($_SESSION['id'])){ ?>
                            ...
                            <a
                                href='viewcheckviewshoes.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>'><?php echo $title, $lockimg;?>
                      ...
                      if(isset($_SESSION['id'])){ ?>
                                    ...
                                    <!-- viewtest.php에서 viewreplytest.php로 고쳤다. GET으로 게시판 idx, idxpost, category를 보낸다. -->
                                    <a
                                        href="viewpagereplyshoes.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>"><?php echo $title; ?>
        ...
        <form action="viewwriteshoes.php" method="post" enctype="multipart/form-data">
