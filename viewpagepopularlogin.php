...
// 밑에 idx는 shopdatanewrelease테이블의 idx이다!!!!!
 ...
 $sql = mq("select * from shopdatapopular where idx='$idx'"); /* 받아온 idx값을 선택 */
...
<div class="href1">
    ...
    <div class="detailimg">
            ...
            GET으로 viewtest로 보낸다. -->
                ...
                if($board['lock_post']=="1"){ ?>
                        ...
                        <?php                                         
                            ...
                            <a href='viewcheckviewpopular.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>'><?php echo $title, $lockimg;?>
               ...
               <?php }else{  ?>
                        ...
                        if(isset($_SESSION['id'])){ ?>
                             ...
                             <!-- viewtest.php에서 viewreplytest.php로 고쳤다. GET으로 게시판 idx, idxpost, category를 보낸다. -->
                            <a href="viewpagereplypopular.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>"><?php echo $title; ?>
        ...
        <?php 
            ...
            <form action="viewwritepopular.php" method="post" enctype="multipart/form-data">
