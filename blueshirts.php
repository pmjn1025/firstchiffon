...
<div class="href1">
    ...
    <div id="pattern" class="pattern">
         <ul class="list img-list">
            <li>
                <img src="shirt.jpg" alt="Image Alt Text" class="modelimg"/>
            </li>
                <div class="modeltitle">딥블루 카라 셔츠</div>

        <div class="modeldescription">
            
            <p>기본적인 스타일에 트렌디한 패턴 셔츠입니다.</p>
            <p>색감이 대박으로 나온 데님셔츠입니다.</p>            
            <p>어디를 가든 무난한 디자인으로,</p>
            <p>데일리룩에 정말 적합할것 같습니다.</p>
            <p>옷이 크기때문에 꼭 넣어입기를 하셔야 합니다.</p>
            <br>
            ...
            <form action ="" method="post" onsubmit='return info_chk()'>
                <p> 색상     : 
                    <SELECT NAME=color SIZE=1>
                        ...
                        <OPTION VALUE=2>딥블루</OPTION>
                        <OPTION VALUE=3>딥블루</OPTION>
                        <OPTION VALUE=4>딥블루</OPTION>
                    </SELECT>
                </p>
                ...
                <input type="hidden" name ="title" value ="딥블루 카라 셔츠">
                <input type="hidden" name ="pice" value ="10">
                <input type="hidden" name ="img" value ="http://192.168.119.129/shirt.jpg">
    ...
    <div class="detailimg">            
        <img src="blueshirts.jpg" width="50%" alt="Image Alt Text"/>
    </div>   
    
    <div class="detailimg">            
        <img src="blueshirts1.jpg" width="50%" alt="Image Alt Text"/>
    </div> 

    <div class="detailimg">            
        <img src="blueshirts2.jpg" width="50%" alt="Image Alt Text"/>
    </div> 
    ...
    <div class="board_list_wrap">
        ...
        // boardtest table에서 boardposttest table로 바꿨다.
          $sql = mq("select * from blueshirtsposttest order by idx desc"); 
            while($board = $sql->fetch_array())
            {
              ...
              $sql2 = mq("select * from blueshirtsreplytest where con_num='".$board['idx']."'");
              //num_rows로 정수형태로 출력 
        ...
        ?>
            ...
            GET으로 viewtest로 보낸다. -->
                ...
                { ?><a href='blueshirtscheckview.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
                }else{  ?>
                <!-- viewtest.php에서 viewreplytest.php로 고쳤다. -->
                    <a href="blueshirtsviewreplytest.php?idx=<?php echo $board["idx"];?>"><?php echo $title; }?>
        ...
        <div class="paging">
            <a href="blueshirtswritetest.php" class="bt1">글쓰기</a>
