...
<body>
    ...
    <div class="board_wrap">
       ...
       <!-- =============== enctype="multipart/form-data" 이거 안적으면 업로드자체가 안된다.========================= -->
           ...
           <form action="viewedit_process.php?idx=<?php echo $idx;?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>" method="post" enctype="multipart/form-data">
                   <div class="title">
                       <dl>
                           <dt>제목</dt>
                           <dd>                           
            ...
            <div class="bt_wrap">
                ...
                <input type ='submit' class="submit_btn" value ="수정"></a>
                 <a href="viewpagereply.php?idx=<?php echo $idx;?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>">취소</a>
