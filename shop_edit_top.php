...
padding-left : 543px;
        ...
        <div class="title">Top</div>
            ...
            <form action= "shop_edit_top_process.php?idx=<?php echo $idx; ?>" method="post" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <input type ="button" onclick="location.href='shop_list_top.php'" value="수정취소">
