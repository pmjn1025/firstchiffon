...
?> 
<script type="text/javascript">alert('수정되었습니다.'); location.replace("viewpagereplytop.php?idx=<?php echo $bno;?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>");</script>
<?php
