...
<form action= "shop_add_newrelease.php" method="post" enctype="multipart/form-data">
<div class="category">
<p> 카테고리  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<tr>
<td>상품명확인(관리자) </td>
<td><input type="text" name= "subtitle" size="30"></td>
</tr>
...
<tr>
<td style="padding-top: 20px">상품 대표 사진</td>
<td style="padding-top: 20px"><input type="file" name="img"></td>
</tr>

<tr>
<td style="padding-top: 20px">상품 상세 사진</td>
<td style="padding-top: 20px"><input type="file" name="fileToUpload[]" multiple='multiple'></td>
</tr>

<tr>
<td colspan="2" textalign="center" style="padding-top:20px">
<input type="submit" value="상품등록">
<input type ="button" onclick="location.href='shop_list_newrelease.php'" value="등록취소">
</td>
</tr>
</table>
</form>
