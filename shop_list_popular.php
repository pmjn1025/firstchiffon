...
<div class="btn">
 ...
 <input type="button" value="상품추가" onClick="location.href='additempopular.php'">
...
<?php
    ...
    $sql = mq("select * from shopdatapopular order by idx desc");
        ...
        <td width="100px">            
            <a href ="shop_edit_popular.php?idx=<?php echo $board['idx']; ?>"  style="text-decoration: none;" >상품수정</a> <br>
            <a href="shop_del_popular.php?idx=<?php echo $board['idx'];?>" style="text-decoration: none;" >상품삭제</a></td>
        </tr>
