<?php
	...
	$idx = $_GET['idx'];
	$sql = mq("select * from boardtest where idx='$idx';");
...
<a href="home.php" class="title1">Chiffons</a>
    ...
    <div class="board_wrap">
       ...
       <!-- =============== enctype="multipart/form-data" 이거 안적으면 업로드자체가 안된다.========================= -->
           ...
           <form action="blacktshirtsedittest_process.php?idx=<?php echo $idx; ?>" method="post" enctype="multipart/form-data">
                   <div class="title">
                       <dl>
                           <dt>제목</dt>
                           <dd>                           
                   ...
                   <div class="info">
                        <dl>
                           <dt>글쓴이</dt>
                           <dd><input type="text" name="id" placeholder="작성자 입력" value="">
                        </dd>
                       </dl>
                       <dl>
                        <dt>비밀번호</dt>
                        <dd><input type="password" name="pw" placeholder="비밀번호 입력"value="">
                        </dd>
                    </dl>
                    </div>
                   <div class="cont">
