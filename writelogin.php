<?php
//?id=아이디 post로 주었지만? get방식으로 표시된다? 그럼 get으로 받자.
$id=$_GET['id'];
...
<body>
<div class="title1"><a href="homelogin.php?id=<?php echo $id ?>">Chiffons</a></div>
    <!-- 중요포인트 이렇게도 묶일 수 있다. -->
    ...
    <div class="subtitle1">Since 2021</div>
        ...
        <div class="href">       
            <a href="toplogin.php?id=<?php echo $id ?>">Top</a>
            <a href="outerlogin.php?id=<?php echo $id ?>">Outer</a>
            <a href="bottomlogin.php?id=<?php echo $id ?>">Bottom</a>
            <a href="shoeslogin.php?id=<?php echo $id ?>">Shoes</a>
            <a href="contactlogin.php?id=<?php echo $id ?>">Contact</a>            
        </div> 
    ...
    <div class="board_wrap">
       ...
       <form action = "create_process1.php" method="post">
       ...
       <!-- 게시판 리스트 -->
           <div class="board_write">
                   ...
                   <div class="info">
                        <dl>
                           <dt>글쓴이</dt>
                           <dd><input type="text" name="writer" placeholder="작성자 입력">
                        </dd>
                       </dl>
                       <dl>
                        <dt>비밀번호</dt>
                   ...
                   <div class="cont">
                       <textarea name="description" placeholder="내용 입력">글내용이 들어갑니다.
            ...
            <div class="bt_wrap">
                ...
                <input type ='submit' class="on">등록</a>                
                 <a href="contactlogin.php?id=<?php echo $id ?>">취소</a>
