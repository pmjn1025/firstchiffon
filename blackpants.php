...
<div class="href1">
    ...
    <div id="pattern" class="pattern">
         <ul class="list img-list">
            <li>
                <img src="bottom.jpg" alt="Image Alt Text" class="modelimg"/>
            </li>
                <div class="modeltitle">검정 면바지</div>

        <div class="modeldescription">
            
            <p>무난한 디자인의 검정 면바지입니다.</p>
            <p>바지안에 밴딩 처리를 하여 입기가 편합니다.</p>            
            <p>또한 슬랙스재질이라서 장시간 앉아있어도,</p>
            <p>주름이 잘 가지 않습니다.</p>
            <p>어느장소에 어울리게 검정 면바지를 준비했습니다.</p>
            <br>
            ...
            <form action ="" method="post" onsubmit='return info_chk()'>
                ...
                <p> 사이즈     : 
                    <SELECT NAME=size SIZE=1>
                        ...
                        <OPTION VALUE=5>34 - L</OPTION>
                        <OPTION VALUE=6>36 - XL</OPTION>
                    </SELECT>
                </p>
                ...
                <input type="hidden" name ="title" value ="검정 면바지">
                <input type="hidden" name ="pice" value ="10">
                <input type="hidden" name ="img" value ="http://192.168.119.129/buttom.jpg">
    ...
    <div class="detailimg">            
        <img src="blackpants.jpg" width="50%" alt="Image Alt Text"/>
    </div>   
    
    <div class="detailimg">            
        <img src="blackpants1.jpg" width="50%" alt="Image Alt Text"/>
    </div> 

    <div class="detailimg">            
        <img src="blackpants2.jpg" width="50%" alt="Image Alt Text"/>
    </div> 

    <div class="detailimg">            
        <img src="pantssize.jpg" width="60%" alt="Image Alt Text"/>
    </div> 
    ...
    <div class="board_list_wrap">
        ...
        // boardtest table에서 boardposttest table로 바꿨다.
          $sql = mq("select * from blackpantsposttest order by idx desc"); 
            while($board = $sql->fetch_array())
            {
              ...
              $sql2 = mq("select * from blackpantsreplytest where con_num='".$board['idx']."'");
              //num_rows로 정수형태로 출력 
        ...
        ?>
            ...
            GET으로 viewtest로 보낸다. -->
                ...
                { ?><a href='blackpantscheckview.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
                }else{  ?>
                <!-- viewtest.php에서 viewreplytest.php로 고쳤다. -->
                    <a href="blackpantsviewreplytest.php?idx=<?php echo $board["idx"];?>"><?php echo $title; }?>
        ...
        <div class="paging">
            <a href="blackpantswritetest.php" class="bt1">글쓰기</a>
