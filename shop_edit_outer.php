...
padding-left : 543px;
        ...
        <div class="title">Outer</div>
            ...
            <form action= "shop_edit_outer_process.php?idx=<?php echo $idx; ?>" method="post" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <input type ="button" onclick="location.href='shop_list_outer.php'" value="수정취소">
