...
padding-left : 543px;
        ...
        <div class="title">Popular</div>
            ...
            <form action= "shop_edit_popular_process.php?idx=<?php echo $idx; ?>" method="post" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <input type ="button" onclick="location.href='shop_list_popular.php'" value="수정취소">
