...
?>
			...
			<?php
                ...
                <?php
					...
					<script type="text/javascript">location.replace("viewpagereplyouter.php?idx=<?php echo $board["idx"]; ?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>");</script><!-- pwk와 bpw값이 같으면 read.php로 보내고 -->

                     <?php } else { ?>

					<script type="text/javascript">location.replace("viewpageouterlogin.php?idx=<?php echo $idxpost;?>");alert('비밀글입니다.');</script><!--- 아니면 비밀번호가 틀리다는 메시지를 보여줍니다 -->
