...
if($pwk !="" && $bpw !="")	{
	...
	<script type="text/javascript">alert('댓글이 삭제되었습니다.'); location.replace("viewpagereplypopular.php?idx=<?php echo $bno;?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>");</script>
	<?php
