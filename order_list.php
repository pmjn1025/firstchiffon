...
<body>
    ...
    <h2 style="text-align : center;"> 전체 주문목록</h2>
    ...
    $sql = mq("select * from shopbasket order by idx desc");

        while($board = $sql->fetch_array()){?>
        <tr>
            <td width="50px"><?php echo $board['idx'];?></td>

            <td width="150px"><?php echo $board['id'];?></td>

            <td width="150px"><?php echo $board['category'];?></td>

            <td width="380px"><?php echo $board['title'];?></td>

            <td width="400px">
                <img width="50%" alt="사진" onerror="this.style.display='none'"
                    src="./<?php echo $board['subtitle'];?>/<?php echo $board['img'];?>">
            </td>
            ...
            <td width="130px"><?php echo $board['date'];?></td>

            <td width="160px">

                <a href="shopbasketdeleteadmin.php?idx=<?php echo $board['idx'];?>"
                    style="text-decoration: none;">상품삭제</a>
            </td>
        </tr>
