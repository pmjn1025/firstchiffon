...
<div class="href1">
    ...
    <div id="pattern" class="pattern">
         <ul class="list img-list">
            <li>
                <img src="shoes.jpg" alt="Image Alt Text" class="modelimg"/>
            </li>
                <div class="modeltitle">Nike Air Force one</div>

        <div class="modeldescription">
            
            <p>Nike Air Force 1 Shadow pastel 입니다.</p>
            <p>디자인이 깔끔하고 색상이 파스텔입니다.</p>            
            <p>신고 다니면 한번씩 물어보는 슈즈가 아닐까 싶습니다.</p>           
            <p>케쥬얼 보다는 트레이닝복에 어울리는 슈즈입니다.</p>
            <p>---------------------------------------------- </p>
            <p>사이즈가 230과 260만 있는점 양해 부탁드립니다.</p>
            <p>---------------------------------------------- </p>
            <br>
            ...
            <form action ="" method="post" onsubmit='return info_chk()'>
                <p> 색상     : 
                    <SELECT NAME=color SIZE=1>
                        ...
                        <OPTION VALUE=3>파스텔</OPTION>
                        <OPTION VALUE=4>파스텔</OPTION>
                    </SELECT>
                </p>
                ...
                <input type="hidden" name ="title" value ="Nike Air Force one">
                <input type="hidden" name ="pice" value ="10">
                <input type="hidden" name ="img" value ="http://192.168.119.129/shoes.jpg">
    ...
    <div class="detailimg">            
        <img src="nikeshoes.jpg" width="50%" alt="Image Alt Text"/>
    </div>   
    
    <div class="detailimg">            
        <img src="nikeshoes1.jpg" width="50%" alt="Image Alt Text"/>
    </div> 

    <div class="detailimg">            
        <img src="nikeshoes2.jpg" width="50%" alt="Image Alt Text"/>
    </div> 
    ...
    <div class="board_list_wrap">
        ...
        // boardtest table에서 boardposttest table로 바꿨다.
          $sql = mq("select * from nikeshoesposttest order by idx desc"); 
            while($board = $sql->fetch_array())
            {
              ...
              $sql2 = mq("select * from nikeshoesreplytest where con_num='".$board['idx']."'");
              //num_rows로 정수형태로 출력 
        ...
        ?>
            ...
            GET으로 viewtest로 보낸다. -->
                ...
                { ?><a href='nikeshoescheckview.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
                }else{  ?>
                <!-- viewtest.php에서 viewreplytest.php로 고쳤다. -->
                    <a href="nikeshoesviewreplytest.php?idx=<?php echo $board["idx"];?>"><?php echo $title; }?>
        ...
        <div class="paging">
            <a href="nikeshoeswritetest.php" class="bt1">글쓰기</a>
