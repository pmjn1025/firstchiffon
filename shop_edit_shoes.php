...
padding-left : 543px;
        ...
        <div class="title">Shoes</div>
            ...
            <form action= "shop_edit_shoes_process.php?idx=<?php echo $idx; ?>" method="post" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <input type ="button" onclick="location.href='shop_list_shoes.php'" value="수정취소">
