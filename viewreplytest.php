...
<div class="title1"><a href="viewhomelogin.php">Chiffons</a></div>
    <!-- 중요포인트 이렇게도 묶일 수 있다. -->
    ...
    <div class="subtitle1">Since 2021</div>
        ...
        <div class="href">       
            <a href="viewtoplogin.php?id=Top">Top</a>
            <a href="viewouterlogin.php?id=Outer">Outer</a>
            <a href="viewbottomlogin.php?id=Bottom">Bottom</a>
            <a href="viewshoeslogin.php?id=Shoes">Shoes</a>
    ...
    <div class="board_wrap">
       ...
       <?php
        ...
        $hit = mysqli_fetch_array(mq("select * from boardposttest where idx ='$idx'"));
        // 조회수에 1을 더해준다.
        $hit = $hit['hit'] + 1;
        // 조회수에 1을 더해준것을 db에 최신화 시켜준다.
        //boardtest table에서 boartposttest table로 바꿨다.
		$fet = mq("update boardposttest set hit = '$hit' where idx = '$idx'");
       ...
       <!-- 글쓰는 영역 -->
           <div class="board_view">
            ...
            <div class="bt_wrap">
                <a href="contacttestlogin.php" class="on">목록</a>                
...
<div class="reply_view">
	<div class="reply_title">댓글목록</div>
		<?php
			$sql3 = mq("select * from replytest where con_num='$idx' order by idx desc");
		...
		<div class="dap_lo">
			...
			<!-- 댓글 수정 폼 dialog -->
			<div class="dat_edit">
				<form method="post" action="replyedittest_process.php">
					...
					<input type="hidden" name="pw" value=<?php echo $_SESSION['password'] ?> class="dap_sm" placeholder="비밀번호" />
			...
			<div class='dat_delete'>
				...
				<form action="replydeletetest_process.php" method="post">
					<input type="hidden" name="rno" value="<?php echo $reply['idx']; ?>" />
                    <input type="hidden" name="b_no" value="<?php echo $idx; ?>">
	...
	<div class="dap_ins">
		<form action="replytest_process.php?idx=<?php echo $idx; ?>" method="post">
