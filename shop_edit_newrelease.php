...
padding-left : 543px;
        ...
        <div class="title">New Release</div>
            ...
            <form action= "shop_edit_newrelease_process.php?idx=<?php echo $idx; ?>" method="post" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <input type ="button" onclick="location.href='shop_list_newrelease.php'" value="수정취소">
