...
<div class="href1">
    ...
    <div id="pattern" class="pattern">
         <ul class="list img-list">
            <li>
                <img src="shirt3.jpg" alt="Image Alt Text" class="modelimg"/>
            </li>
                <div class="modeltitle">오픈 카라 반팔 셔츠</div>

        <div class="modeldescription">
            
            <p>오픈카라 디자인에 스타일링 하기 좋은 캐주얼 셔츠 입니다.</p>
            <p>베이직한 핏으로 제작되어</p>
            <p>부담없이 편하게 착용하실수 있습니다.</p>
            <p>댄디하면서 캐주얼한 디자인으로,</p>
            <p>다양한 하의와 매치해서</p>
            <p>멋스럽게 코디하기 좋은 셔츠 입니다.</p>
            <br>
            ...
            <form action ="" method="post" onsubmit='return info_chk()'>
                ...
                <input type="hidden" name ="title" value ="오픈 카라 반팔 셔츠">
                <input type="hidden" name ="pice" value ="10">
                <input type="hidden" name ="img" value ="http://192.168.119.129/shirts3.jpg">
    ...
    <div class="detailimg">            
        <img src="openkara.jpg" width="50%" alt="Image Alt Text"/>
    </div>   
    
    <div class="detailimg">            
        <img src="openkara1.png" width="50%" alt="Image Alt Text"/>
    </div> 

    <div class="detailimg">            
        <img src="openkara2.png" width="50%" alt="Image Alt Text"/>
    </div> 
    ...
    <div class="board_list_wrap">
        ...
        // boardtest table에서 boardposttest table로 바꿨다.
          $sql = mq("select * from openkaraposttest order by idx desc"); 
            while($board = $sql->fetch_array())
            {
              ...
              $sql2 = mq("select * from openkarareplytest where con_num='".$board['idx']."'");
              //num_rows로 정수형태로 출력 
        ...
        ?>
            ...
            GET으로 viewtest로 보낸다. -->
                ...
                { ?><a href='openkaracheckview.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
                }else{  ?>
                <!-- viewtest.php에서 viewreplytest.php로 고쳤다. -->
                <!-- 게시판 title 클릭시 이동하는 곳. -->
                    <a href="openkaraviewreplytest.php?idx=<?php echo $board["idx"];?>"><?php echo $title; }?>
        ...
        <div class="paging">
            <a href="openkarawritetest.php" class="bt1">글쓰기</a>
