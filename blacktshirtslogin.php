...
<div class="href1">
    ...
    <div id="pattern" class="pattern">
         <ul class="list img-list">
            <li>
                <img src="model3.jpg" alt="Image Alt Text" class="modelimg"/>
            </li>
                <div class="modeltitle">레터링 검정 티셔츠</div>

        <div class="modeldescription">
            
            <p>검정 레터링 티셔츠입니다.</p>
            <p>검정에 레터링을 하여 포인트가 있는 티셔츠입니다.</p>            
            <p>베이직 화이트 티셔츠와 마찬가지로 심플하며,</p>           
            <p>어떤 하의에도 잘 어울리는 티셔츠 입니다.</p>
            <p>---------------------------------------------- </p>
            <p>사이즈는 105가 끝이며 XXL사이즈는 없습니다.</p>
            <p>---------------------------------------------- </p>
            <br>
    ...
    <div class="detailimg">            
        <img src="blacktshirts.jpg" width="50%" alt="Image Alt Text"/>
    </div>   
    
    <div class="detailimg">            
        <img src="blacktshirts1.png" width="50%" alt="Image Alt Text"/>
    </div> 

    <div class="detailimg">            
        <img src="blacktshirts2.png" width="50%" alt="Image Alt Text"/>
    </div> 
    ...
    <div class="board_list_wrap">
        ...
        // boardtest table에서 boardposttest table로 바꿨다.
          $sql = mq("select * from blacktshirtsposttest order by idx desc"); 
            while($board = $sql->fetch_array())
            {
              ...
              $sql2 = mq("select * from blacktshirtsreplytest where con_num='".$board['idx']."'");
              //num_rows로 정수형태로 출력 
        ...
        ?>
            ...
            GET으로 viewtest로 보낸다. -->
                ...
                { ?><a href='blacktshirtscheckview.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
                }else{  ?>
                <!-- viewtest.php에서 viewreplytest.php로 고쳤다. -->
                    <a href="blacktshirtsviewreplytest.php?idx=<?php echo $board["idx"];?>"><?php echo $title; }?>
        ...
        <div class="paging">
            <a href="blacktshirtswritetest.php" class="bt1">글쓰기</a>
