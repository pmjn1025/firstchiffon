...
<div class="btn">
 ...
 <input type="button" value="상품추가" onClick="location.href='additembottom.php'">
...
<?php
    ...
    $sql = mq("select * from shopdatabottom order by idx desc");
        ...
        <tr>
            ...
            <td width="400px">
            <img width="40%" alt ="사진" onerror="this.style.display='none'" src="./<?php echo $board['subtitle'];?>/<?php echo $board['img'];?>"></td>
        ...
        <td width="100px">            
            <a href ="shop_edit_bottom.php?idx=<?php echo $board['idx']; ?>"  style="text-decoration: none;" >상품수정</a> <br>
            <a href="shop_del_bottom.php?idx=<?php echo $board['idx'];?>" style="text-decoration: none;" >상품삭제</a></td>
        </tr>
