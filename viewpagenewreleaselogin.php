...
?>
        ...
        <ul class="list img-list">
            ...
            <div class="modeldescription1">
             ...
             if(isset($_SESSION['id'])){ ?>
                ...
                <!-- 밑에 액션 장바구니 -->
                <form action="shopbasket_process.php" target="_blank" method="post" onsubmit='return info_chk()'>
                ...
                if($board['color1'] == '블랙'){?>
                    ...
                    <!-- 게시판 생성 후 이것 살펴보기. -->
                    <input type="hidden" name="title" value="<?php echo $board['title']; ?>">
                    <input type="hidden" name="pice" value="<?php echo $board['price']; ?>">
                    <input type="hidden" name="img" value="<?php echo $board['img']; ?>">
                    <input type="hidden" name="subtitle" value="<?php echo $board['subtitle']; ?>">
                    <input type="hidden" name="subtitle" value="<?php echo $boar['subtitle']; ?>">
    ...
    <div class="detailimg">
        ...
        ?>
            ...
            GET으로 viewtest로 보낸다. -->
                ...
                if($board['lock_post']=="1"){ ?>
                            ...
                            <a
                                href='viewcheckview.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>'><?php echo $title, $lockimg;?>
                            ...
                            if(isset($_SESSION['id'])){ ?>
                                    ...
                                    <!-- viewtest.php에서 viewreplytest.php로 고쳤다. GET으로 게시판 idx, idxpost, category를 보낸다. -->
                                    <a
                                        href="viewpagereply.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>"><?php echo $title; ?>
        ...
        <form action="viewwrite.php" method="post" enctype="multipart/form-data">
