...
// 밑에 idx는 shopdatanewrelease테이블의 idx이다!!!!!
 ...
 $sql = mq("select * from shopdatabottom where idx='$idx'"); /* 받아온 idx값을 선택 */
...
?>
    ...
    <a href="viewhomelogin.php" class="title">Chiffons</a>
    ...
    <div id="pattern" class="pattern">
        <ul class="list img-list">
            <li>
                <img src="./<?php echo $board['subtitle'];?>/<?php echo $board['img'];?>" alt="Image Alt Text"
                    class="modelimg" />
            </li>
            ...
            <div class="modeldescription1">
             ...
             if(isset($_SESSION['id'])){ ?>
                ...
                <form action="shopbasket_process.php" method="post" onsubmit='return info_chk()'>
                ...
                if($board['title'] == '청바지'){?>
                    ...
                    <?php } else if($board['title'] == '검정 면바지'){?>
                    <p> 사이즈 :
                        <SELECT NAME=size SIZE=1>
                            <OPTION VALUE=1 SELECTED>사이즈를 선택해 주세요.</OPTION>
                            <OPTION VALUE="30">30</OPTION>
                    ...
                    <p> 수량 : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <input type="number" name="quantity" style="width: 100px;" maxlength="3"
                            oninput="maxLengthCheck(this)" min="1" max="999" step="1" value="1" />

                    </p>

                    <!-- &nbsp; 공백넣기 원래 html은 공백을 1개만 인식하기 때문에 인위적으로 &nbsp;을 넣어서 공백을 만든다.   -->
                    <p>가격 : &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
                        <?php echo $board['price'].'원'; ?> </p>
                    ...
                    <input type="hidden" name="category" value="<?php echo $board['category']; ?>">
                    <input type="hidden" name="title" value="<?php echo $board['title']; ?>">
                    <input type="hidden" name="subtitle" value="<?php echo $board['subtitle']; ?>">
                    <input type="hidden" name="img" value="<?php echo $board['img']; ?>">
                    <input type="hidden" name="price" value="<?php echo $board['price']; ?>">
    ...
    <div class="detailimg">
        ...
        <img src="./<?php echo $board['subtitle'];?>/<?php echo $board1['filename'];?>" width="50%"
            onerror="this.style.display='none'" alt="Image Alt Text" />
            ...
            GET으로 viewtest로 보낸다. -->
                ...
                if($board['lock_post']=="1"){ ?>
                      ...
                      if(isset($_SESSION['id'])){ ?>
                            ...
                            <a
                                href='viewcheckviewbottom.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>'><?php echo $title, $lockimg;?>

                                <?php } else { ?>

                                <!-- viewtest.php에서 viewreplytest.php로 고쳤다. GET으로 게시판 idx, idxpost, category를 보낸다. -->
                                <a
                                    href='loginerror.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>'><?php echo $title, $lockimg;?>
                        ...
                        if(isset($_SESSION['id'])){ ?>
                                    ...
                                    <!-- viewtest.php에서 viewreplytest.php로 고쳤다. GET으로 게시판 idx, idxpost, category를 보낸다. -->
                                    <a
                                        href="viewpagereplybottom.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>"><?php echo $title; ?>

                                        <?php } else { ?>

                                        <a
                                            href="loginerror.php?idx=<?php echo $board["idx"];?>&&idxpost=<?php echo $idx;?>&&category=<?php echo $category;?>"><?php echo $title; ?>
        ...
        <form action="viewwritebottom.php" method="post" enctype="multipart/form-data">
