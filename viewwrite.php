...
.checkbox{
    ...
    <div class="board_wrap">
       ...
       <form action = "viewwrite_process.php" method="post" enctype="multipart/form-data">
       ...
       <!-- 게시판 리스트 -->
           <div class="board_write">
            ...
            <div class="bt_wrap">
                <!-- 나중에 수정하기 -->
                <input type ='submit' class="submit_btn" value='등록'></a>              
                <a href="viewpagenewreleaselogin.php?idx=<?php echo $idxpost;?>">취소</a>
