    ...
    <div class="board_wrap">
       ...
       <!-- 글쓰는 영역 -->
           <div class="board_view">
            ...
            <div class="bt_wrap">
                <a href="viewpagetoplogin.php?idx=<?php echo $idxpost;?>" class="on">목록</a>
                ...
                if(isset($_SESSION['id'])){ ?>
                   ...
                   <?php
                    if($_SESSION['id']== $board['id']){ ?>
                        ...
                        <!-- idx값을 GET으로 넘겨준다 -->
                        <a href="viewedittop.php?idx=<?php echo $board['idx'];?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>">수정</a>
                        <!--delete.php에서 checkdeleteview.php로 바꿨다.  -->
                        <a href="viewdeletetop.php?idx=<?php echo $board['idx'];?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>">삭제</a>
...
<div class="reply_view">
	<div class="reply_title">댓글목록</div>
		...
		<div class="dap_lo">
			...
			<!-- 댓글 수정 폼 dialog -->
			<div class="dat_edit">
				<form method="post" action="viewreplyedittop_process.php?idx=<?php echo $idx;?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>">
			...
			<div class='dat_delete'>
				...
				<form action="viewreplydeletetop_process.php?idx=<?php echo $idx;?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>" method="post">
					<input type="hidden" name="rno" value="<?php echo $reply['idx']; ?>" />
                    <input type="hidden" name="b_no" value="<?php echo $idx; ?>">
	...
	<div class="dap_ins">
		<form action="viewreplytop_process.php?idx=<?php echo $idx;?>&&idxpost=<?php echo $idxpost;?>&&category=<?php echo $category;?>" method="post">
